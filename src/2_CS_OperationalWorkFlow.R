...
debugmode <- TRUE  # or FALSE when running normally
if (debugmode) {
...
#### Parameters to be reset by each user: ______________________________________________________________________________####
    ...
    setwd("C:/Users/a.batlle/OneDrive - CREAF/Documentos/local_I-CISK/SMHI/SC_implementation")
    
    # Modelling inputs
    # Directory for Bias_corrected forecast input
    forecast_input <- "test_data"
